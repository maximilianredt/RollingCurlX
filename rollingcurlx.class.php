...
Class RollingCurlX
{
	...
	{ //Add to request queue
		$i = count($this->requests) - 1;
		$this->queue[$i] = $this->requests[$i] = [
			'url' => $url,
		...
		return $i; //return request number/index
	}
	...
	public function execute()
	{
		...
		$this->startCurlRequests($multi_handle, $requests_map);
		do {
